...
class LcsSimilarityBenchmark {

  @Param(Array("short-low-overlap", "short-high-overlap", "medium-low-overlap", "medium-high-overlap", "long-low-overlap", "long-high-overlap"))

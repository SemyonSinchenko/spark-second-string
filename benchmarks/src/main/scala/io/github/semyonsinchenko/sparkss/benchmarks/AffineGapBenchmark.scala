...
import io.github.semyonsinchenko.sparkss.expressions.matrix.{AffineGap, Jaro, LcsSimilarity, Levenshtein, NeedlemanWunsch, SmithWaterman}
...
class AffineGapBenchmark {
  ...
  @Warmup(iterations = 2, time = 1, timeUnit = TimeUnit.SECONDS)
  @Measurement(iterations = 3, time = 1, timeUnit = TimeUnit.SECONDS)
  def smithWatermanBaseline(): Double = {

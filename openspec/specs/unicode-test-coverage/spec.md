...
Define deterministic and bounded Unicode coverage requirements across matrix, token, and phonetic metric families, including UTF-8 fallback behavior contracts.

# Phonetic Pre-Processing Expressions

## Purpose

Define unary phonetic encoding expressions and namespaced SQL registrations that support composition with similarity metrics.

# Configurable Metric Parameters

## Purpose

Define configurable runtime parameters for selected matrix metrics and Monge-Elkan while preserving backward-compatible defaults and SQL stability.

# Legacy UDF Benchmark Flow

## Purpose

Define requirements for running a legacy Java SecondString baseline through Spark UDF benchmarks with parity-safe measurement semantics.
